...
description: "Configure LM Studio to run local LLMs with VibeBrowser"
icon: "desktop"
---
...
<Steps>
  ...
  <Step title="Configure in VibeBrowser">
    - Navigate to `chrome://settings/VibeBrowser-ai` or go to **Settings → VibeBrowser AI**
    - Click **Add Provider**
    - Select **OpenAI Compatible** in the Provider Type dropdown

    <Frame>
      <img src="/images/setting-up-lm-studio/lmstudio-step3.png" alt="Configure in VibeBrowser" />
    </Frame>
  </Step>
  ...
  <Step title="Use the Model">
    Select the model in VibeBrowser agent and start using it! 🎉

    <Frame>
      <img src="/images/setting-up-lm-studio/lmstudio-step5.png" alt="Use the model in VibeBrowser" />
    </Frame>
  </Step>
</Steps>

<Warning>
Ensure the Context Window Size in VibeBrowser matches what you configured in LM Studio to avoid issues with long conversations.
</Warning>
