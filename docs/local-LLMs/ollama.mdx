...
description: "Configure Ollama to work with VibeBrowser for local AI capabilities"
icon: "robot"
---
...
<Steps>
  <Step title="Navigate to AI Settings">
    Navigate to `chrome://settings/VibeBrowser-ai` to add Ollama as a provider.
  </Step>
...
Navigate to the VibeBrowser AI settings page at `chrome://settings/VibeBrowser-ai`
...
Run Ollama with the required CORS settings to allow VibeBrowser to connect:
