...
This guide will walk you through setting up and using OpenAI's GPT-OSS model with LM Studio and VibeBrowser.
...
## Step 2: Configure VibeBrowser to use LM Studio

<Steps>
  <Step title="Add Provider">
    Navigate to `chrome://settings/VibeBrowser-ai` and click **Add Provider**.

    <Frame>
      <img src="/images/using-lm-studio-openais-gpt-oss/lm-studio-openais-step6.png" alt="Configure VibeBrowser to use LMStudio" />
    </Frame>
  </Step>
...
<Cards>
  ...
  <Card title="VibeBrowser Settings" icon="browser">
...
<Accordion title="Context length errors">
  - Make sure the context length in VibeBrowser matches LM Studio
