...
<CardGroup cols={3}>
  <Card
    ...
    icon="github"
    href="https://github.com/VibeBrowser/VibeBrowser"
  >
  ...
  <Card
    title="Report Issues"
    icon="bug"
    href="https://github.com/VibeBrowser/VibeBrowser/issues"
  >
...
<Note>
For detailed setup, architecture, and code standards, see the [Agent Contributing Guide](https://github.com/VibeBrowser/VibeBrowser/blob/main/packages/vibebrowser-agent/CONTRIBUTING.md).
</Note>
...
- Agent: [packages/vibebrowser-agent/CLAUDE.md](https://github.com/VibeBrowser/VibeBrowser/blob/main/packages/vibebrowser-agent/CLAUDE.md)
</Note>
...
<CardGroup cols={3}>
  ...
  <Card
    title="GitHub Issues"
    icon="bug"
    href="https://github.com/VibeBrowser-ai/VibeBrowser/issues"
  >
  ...
  <Card
    ...
    icon="comments"
    href="https://github.com/VibeBrowser-ai/VibeBrowser/discussions"
  >
    General questions
  </Card>
</CardGroup>
