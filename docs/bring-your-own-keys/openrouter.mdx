---
title: "Open Router"
description: "Configure VibeBrowser to use Open Router for access to multiple AI models"
---
...
Click the settings icon in VibeBrowser, then click **USE** on the OpenRouter card.
...
In VibeBrowser, paste the model ID into **Model ID** field. The model ID should be in the format shown under "Custom" (e.g., `openai/gpt-4.1-mini`). Paste your OpenRouter API key, set **Context Window Size** based on the model, and check **Supports Images** if the model supports it. Click **Save**.
