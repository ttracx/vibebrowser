---
title: "Claude"
description: "Configure VibeBrowser to use Anthropic's Claude AI assistant"
---
...
Click the settings icon in VibeBrowser, then click **USE** on the Claude card. Paste your API key and set your model. For Claude Sonnet 4.0, use model ID `claude-opus-4-20250514`, set **Context Window Size** to `128000`, and check **Supports Images**. Click **Save**.

![image.png](/docs/images/image.png)

Done! You're ready to use VibeBrowser with Claude.
---
<p align="center">
