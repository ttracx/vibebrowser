---
title: "Gemini"
description: "Configure VibeBrowser to use Google's Gemini AI model"
---

Gemini 2.5 Flash is fast, powerful, and free. Google AI Studio gives you 20 requests per minute at no cost - perfect for VibeBrowser.
...
Click the settings icon in VibeBrowser, then click **USE** on the Gemini card.
...
Done! You're ready to use VibeBrowser with Gemini.
---
<p align="center">
