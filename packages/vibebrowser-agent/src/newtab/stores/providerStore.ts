...
const DEFAULT_PROVIDERS: Provider[] = [
  {
    id: 'vibebrowser-agent',
    name: 'VibeBrowser Agent',
    category: 'llm',
    actionType: 'sidepanel',
    available: true,
    iconUrl: '/assets/new_tab_search/vibebrowser.svg'
  },
  {
    id: 'chatgpt',
    name: 'ChatGPT',
...
export const useProviderStore = create<ProviderState & ProviderActions>()(
  persist(
    (set, get) => ({
      ...
      customProviders: [],
      selectedProviderId: 'vibebrowser-agent',
      isDropdownOpen: false,
      enabledProviderIds: ['vibebrowser-agent', 'chatgpt', 'claude', 'google'],
      ...
      removeCustomProvider: id => {
        set(state => {
          ...
          const nextSelected = isSelected
            ? normalized.enabledProviderIds[0] || 'vibebrowser-agent'
      ...
      importLegacyProviderSettings: () => {
        ...
        try {
          ...
          const mapLegacyId = (id: string) => (id === 'vibebrowser' ? 'vibebrowser-agent' : id)
    ...
    }),
    {
      ...
      migrate: (persistedState, version) => {
        ...
        return {
          providers: DEFAULT_PROVIDERS,
          customProviders,
          selectedProviderId: legacyState.selectedProviderId || 'vibebrowser-agent',
          isDropdownOpen: false,
          enabledProviderIds: normalized.enabledProviderIds,
          disabledProviderIds: normalized.disabledProviderIds,
          hasLegacySynced: false
