...
const PROVIDER_CONFIG: Record<string, {
  ...
  ollama: {
    ...
    setupNote: 'Required',
    docLink: 'https://docs.vibebrowser.com/local-LLMs/ollama',
    displayName: 'Ollama'
  },
  openai: {
    apiKeyLink: 'https://platform.openai.com/api-keys',
    docLink: 'https://docs.vibebrowser.com/bring-your-own-keys/openai',
    displayName: 'OpenAI'
  },
  anthropic: {
    apiKeyLink: 'https://console.anthropic.com/settings/keys',
    docLink: 'https://docs.vibebrowser.com/bring-your-own-keys/claude',
    displayName: 'Claude'
  },
  google_gemini: {
    apiKeyLink: 'https://aistudio.google.com/app/apikey',
    docLink: 'https://docs.vibebrowser.com/bring-your-own-keys/gemini',
    displayName: 'Gemini'
  },
  openrouter: {
    apiKeyLink: 'https://openrouter.ai/keys',
    docLink: 'https://docs.vibebrowser.com/bring-your-own-keys/openrouter',
    displayName: 'OpenRouter'
  },
  openai_compatible: {
    docLink: 'https://docs.vibebrowser.com/llm-setup-guide'
  }
}
