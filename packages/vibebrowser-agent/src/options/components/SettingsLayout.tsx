...
export function SettingsLayout({ children, activeSection: controlledSection, onSectionChange }: SettingsLayoutProps) {
  ...
  const [internalActiveSection, setInternalActiveSection] = useState('vibebrowser-ai')
