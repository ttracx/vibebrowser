 ...
 * 7. Set BRAINTRUST_PROJECT_NAME in your .env file (defaults to 'vibebrowser-agent-online')
 * 
 * For the simplified evals2 system:
 * 1. Set ENABLE_EVALS2 = true in your .env file
 * 2. Set BRAINTRUST_API_KEY in your .env file
 * 3. Set BRAINTRUST_PROJECT_NAME in your .env file (defaults to 'vibebrowser-agent-online')
 * 4. Rebuild
 */
...
export const BRAINTRUST_PROJECT_NAME = process.env.BRAINTRUST_PROJECT_NAME || 'vibebrowser-agent-online';
