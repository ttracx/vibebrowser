    ...
    <div className="flex flex-col space-y-8 max-w-5xl mx-auto px-4">
      ...
      <div className="text-center space-y-4 pt-16">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text">
          VibeBrowser as MCP Server
        </h2>
        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          Connect VibeBrowser with Claude Code, Claude Desktop, and other MCP clients for powerful agentic browser automation
        </p>
      </div>
        ...
        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl shadow-brand/20 border-2 border-border/50 bg-card">
          ...
          <div className="relative pb-[56.25%]">
            <video
              ...
              src="https://pub-80f8a01e6e8b4239ae53a7652ef85877.r2.dev/resources/vibebrowser-as-mcp-server.mp4"
              title="VibeBrowser MCP Server Demonstration"
              autoPlay
              muted
              loop
              playsInline
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-card/80 to-background/60 backdrop-blur-sm border-2 border-border/60 rounded-xl p-5 hover:border-brand/50 hover:shadow-lg hover:shadow-brand/10 transition-all duration-300">
          <div className="flex items-start gap-3">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-brand/15 to-purple-500/15 border border-brand/20 flex items-center justify-center flex-shrink-0">
      ...
      <div className="text-center p-4 bg-muted/30 border border-border/50 rounded-xl">
        <p className="text-sm text-muted-foreground">
          💡 <span className="font-semibold">Pro Tip:</span> Use commands like "Open amazon.com on vibebrowser" to control your browser directly from Claude!{' '}
          <a
            href="https://docs.vibebrowser.com/vibebrowser-mcp/how-to-guide"
