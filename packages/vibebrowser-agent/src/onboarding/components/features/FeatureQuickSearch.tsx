...
export function FeatureQuickSearch() {
  ...
  const handleOpenSettings = () => {
    chrome.tabs.create({ url: 'chrome://settings/vibebrowser' })
  }
  ...
  return (
    <div className="flex flex-col space-y-8 max-w-5xl mx-auto px-4">
      ...
      <div>
        <div className="relative w-full rounded-2xl overflow-hidden shadow-2xl shadow-brand/20 border-2 border-border/50 bg-card">
          ...
          <div className="relative pb-[56.25%]">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-brand/10 to-purple-500/10 -z-10" />
          </div>
        </div>
      </div>
      ...
      <NavigationControls
        ...
        nextLabel="Start Using VibeBrowser"
        nextButtonPrimary
      />
    </div>
  )
