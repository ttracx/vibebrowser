...
export function StepThree() {
  ...
  const exampleQueries = [
    ...
    },
    {
      id: 'teach-mode',
      title: 'Teach Mode',
      description: 'VibeBrowser has a teach mode where you show our agent a workflow and it can learn and repeat that',
    ...
    {
      id: 'mcp-server',
      title: 'VibeBrowser as MCP server',
      description: 'VibeBrowser comes with an in-built MCP server, that you can add to claude code, gemini-cli or cursor. This allows you to control VibeBrowser from other apps.',
    ...
    <div className="flex flex-col space-y-8 max-w-5xl mx-auto px-4">
      ...
      <div className="text-center space-y-4 pt-16">
        ...
        <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
          VibeBrowser comes with a built-in AI agent that can execute complex web tasks!
        </p>
      </div>
