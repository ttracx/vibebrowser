    ...
    <div className="flex flex-col space-y-8 max-w-5xl mx-auto px-4">
      ...
      <div className="relative flex justify-center pt-16">
        <div className="relative">
          ...
          <img
            src="/assets/new_tab_search/vibebrowser.svg"
            alt="VibeBrowser"
      ...
      <div className="text-center space-y-4">
        ...
        <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          Your setup is complete! You can start using VibeBrowser or complete a quick tutorial on VibeBrowser's features by clicking orange button (Explore Features) below.</p>
      </div>
      ...
      <div className="max-w-2xl mx-auto w-full">
        <div className="bg-card border border-border rounded-lg p-6 space-y-4">
          <h3 className="text-lg font-semibold flex items-center gap-2">
            ...
            Join our community and help us improve VibeBrowser!
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <a
              href="https://discord.gg/vibebrowser"
              target="_blank"
            ...
            <a
              href="https://github.com/vibebrowser-ai/VibeBrowser"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3 bg-muted/30 hover:bg-muted/50 border border-border hover:border-brand/50 rounded-lg transition-all duration-200 group"
            >
            ...
            <a
              href="https://docs.vibebrowser.com"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3 bg-muted/30 hover:bg-muted/50 border border-border hover:border-brand/50 rounded-lg transition-all duration-200 group"
            >
