...
const processEnv = {
  ...
  'process.env.BRAINTRUST_PROJECT_NAME': JSON.stringify(envKeys.BRAINTRUST_PROJECT_NAME || 'vibebrowser-agent-online'),
...
module.exports = {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: './vibebrowser-settings.html',
      filename: 'vibebrowser-settings.html',
      chunks: ['options']
    }),
    new HtmlWebpackPlugin({
