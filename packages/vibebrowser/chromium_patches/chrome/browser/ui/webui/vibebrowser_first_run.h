diff --git a/chrome/browser/ui/webui/vibebrowser_first_run.h b/chrome/browser/ui/webui/vibebrowser_first_run.h
new file mode 100644
index 0000000000000..51ab05bc94583
--- /dev/null
+++ b/chrome/browser/ui/webui/vibebrowser_first_run.h
@@ -0,0 +1,354 @@
...
+<html lang="en">
+<head>
+<title>VibeBrowser — First Run</title>
+<meta charset="UTF-8">
...
+ <p>VibeBrowser is an AI-powered browser that lets you build and run agents to automate tedious tasks. It looks like Chrome but reimagined for the AI era.</p>
+ <div class="actions">
+  </div>
+</section>
+
...
+  <a class="btn btn-accent" href="https://bit.ly/VibeBrowser-setup">Quick start guide</a>
...
+   <p class="muted" style="margin-top:.35rem">Navigate to <a href="chrome://settings/VibeBrowser"><code>chrome://settings/VibeBrowser</code></a> to configure your own API keys for various providers.</p>
...
+   Step 3: All done!
+  </div>
+  <div class="muted" style="margin-top:.4rem">Your ready to use VibeBrowser, have fun! This page can be always accessed again at <a href="chrome://VibeBrowser-first-run"><code>chrome://VibeBrowser-first-run</code></a></div>
+ </div>
+</section>
+
+<section>
...
+   Discord
+  </a>
+  <a href="https://github.com/VibeBrowser-ai/VibeBrowser">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>GitHub</title>
...
+   GitHub
+  </a>
+  <a href="https://x.com/VibeBrowser_ai">
+   <span class="icon" aria-hidden="true">
+    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
+     <title>X</title>
...
+  public:
+   NxtscapeFirstRunUIConfig() : DefaultWebUIConfig("chrome", "VibeBrowser-first-run") {}
+};
+
