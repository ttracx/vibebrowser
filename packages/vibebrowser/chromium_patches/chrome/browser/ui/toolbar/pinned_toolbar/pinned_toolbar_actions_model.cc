...
+  }
+
+  // Pin native VibeBrowser actions if their features are enabled
+  for (actions::ActionId id : VibeBrowser::kVibeBrowserNativeActionIds) {
+    const base::Feature* feature = VibeBrowser::GetFeatureForVibeBrowserAction(id);
