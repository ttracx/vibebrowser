...
+export {SettingsVibeBrowserPageElement} from './vibebrowser_page/vibebrowser_page.js';
+export {SettingsVibeBrowserPrefsPageElement} from './VibeBrowser_prefs_page/VibeBrowser_prefs_page.js';
