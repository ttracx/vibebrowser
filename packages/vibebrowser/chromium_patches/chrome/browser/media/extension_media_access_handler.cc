...
+// 9. VibeBrowser extensions (AI Side Panel and Bug Reporter)
...
+         extensions::VibeBrowser::IsVibeBrowserExtension(extension->id());
 }
...
+  // For VibeBrowser extensions in sidepanel, allow audio for teach mode
+  if (extensions::VibeBrowser::IsVibeBrowserExtension(extension->id())) {
