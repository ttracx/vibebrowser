...
+class VibeBrowserChangeDetector : public content::WebContentsObserver {
+ public:
...
+  explicit VibeBrowserChangeDetector(content::WebContents* web_contents);
+  ~VibeBrowserChangeDetector() override;
+
+ private:
+  VibeBrowserChangeDetector(const VibeBrowserChangeDetector&) = delete;
+  VibeBrowserChangeDetector& operator=(const VibeBrowserChangeDetector&) = delete;
+
...
+  base::WeakPtrFactory<VibeBrowserChangeDetector> weak_factory_{this};
+};
+
+}  // namespace api
+}  // namespace extensions
