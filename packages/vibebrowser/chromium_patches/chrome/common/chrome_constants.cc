...
+const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("VibeBrowser");
...
-const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("chrome");
-const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("chrome");
+const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("VibeBrowser");
+const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("VibeBrowser");
 #endif  // OS_*
...
+const base::FilePath::CharType kBrowserResourcesDll[] = FPL("VibeBrowser.dll");
+const base::FilePath::CharType kElfDll[] = FPL("VibeBrowser_elf.dll");
