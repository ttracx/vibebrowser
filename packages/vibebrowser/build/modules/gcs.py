#!/usr/bin/env python3
"""
Google Cloud Storage upload module for VibeBrowser build artifacts
"""
...
def upload_to_gcs(
    ...
    Args:
        ctx: BuildContext with root_dir and vibebrowser_version
    ...
    # Build GCS path: gs://vibebrowser/resources/<version>/<platform>/
    gcs_prefix = f"resources/{ctx.vibebrowser_version}/{platform_dir}"
...
def handle_upload_dist(
    ...
    try:
        ...
        ctx.vibebrowser_version = version
    except Exception as e:
        ...
        class MinimalContext:
            def __init__(self, root_dir: Path, version: str):
                ...
                self.vibebrowser_version = version
