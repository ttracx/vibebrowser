#!/usr/bin/env python3
"""
DMG creation and packaging module for VibeBrowser
...
def package(ctx: BuildContext) -> bool:
    ...
    if create_dmg(app_path, dmg_path, "VibeBrowser", pkg_dmg_path):
...
def package_universal(contexts: List[BuildContext]) -> bool:
    ...
    universal_app_path = universal_dir / contexts[0].VIBEBROWSER_APP_NAME
    ...
    if create_dmg(universal_app_path, dmg_path, "VibeBrowser", pkg_dmg_path):
