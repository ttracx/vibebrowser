#!/usr/bin/env python3
"""
Patch management module for VibeBrowser build system
"""
...
def apply_patches(
    ...
    vibebrowser_patches_dir = ctx.get_vibebrowser_patches_dir()

    if not vibebrowser_patches_dir.exists():
        log_error(f"Patches directory not found: {vibebrowser_patches_dir}")
        raise FileNotFoundError(f"Patches directory not found: {vibebrowser_patches_dir}")

    # get all patches in vibebrowser_patches_dir
