#!/usr/bin/env python3
"""
Universal binary merge module for VibeBrowser Browser
...
def merge_sign_package(
    ...
    if package:
        ...
        try:
            ...
            if create_dmg(output_path, dmg_path, "VibeBrowser", pkg_dmg_path):
...
def handle_merge_command(
    ...
    output_path = (
        chromium_src / "out" / "Default_universal" / temp_ctx.VIBEBROWSER_APP_NAME
    )
