#!/usr/bin/env python3
"""
String replacement module for VibeBrowser build system
"""
...
branding_replacements = [
    (
        ...
        r"The VibeBrowser Authors. All rights reserved.",
    ),
    (
        r"Google LLC. All rights reserved.",
        r"The VibeBrowser Authors. All rights reserved.",
    ),
    (r"The Chromium Authors", r"VibeBrowser Software Inc"),
    (r"Google Chrome", r"VibeBrowser"),
    (r"(Google)(?! Play)", r"VibeBrowser"),
    (r"Chromium", r"VibeBrowser"),
    (r"Chrome", r"VibeBrowser"),
]
