...
Injects VibeBrowser version into extension manifests
"""
...
def inject_version_to_manifest(
    manifest_path: Path, browser_version: str, vibebrowser_version: str
) -> bool:
    ...
    try:
        ...
        # Set version to VIBEBROWSER_VERSION formatted as X.0.0.0
        if "version" in manifest_data:
            current_version = manifest_data["version"]
            # Format version as X.0.0.0
            formatted_version = f"{vibebrowser_version}.0.0.0"
